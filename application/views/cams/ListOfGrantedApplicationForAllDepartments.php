<div class="container mt-5 col-sm-3">
    <div class="card">
        <div class="card-header text-center" style="background-color:#F0F8FF">
            List of Granted Application
        </div>
        
    <div class="card-body">
        <form action="ListOfGrantedApplicationForAllDepartmentsPrint" method="post" autocomplete="off" target="_blank">
        ...
        <input type="submit" name="submit-list-of-granted-application-form" class="btn btn-success">
        </form>
    </div>
    </div>
</div>