<div class="container mt-5 col-sm-3">
    ...
    <div class="card-body">
        <form action="ListOfPendingApplicationForAllDepartmentsPrint" method="post" autocomplete="off" target="_blank">
        ...
        <input type="submit" name="submit-list-of-pending-application-form" class="btn btn-success">
        </form>
    </div>
    </div>
</div>